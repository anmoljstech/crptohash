    ...
    <>
      <div id="sidebar" className={`sidebar ${isSidebarVisible ? "show" : ""} ${isSidebarCollapsed ? "collapsed" : ""}`}>
        ...
        <ul className="nav flex-column pt-3">
          ...
          <li className="nav-item">
            <div className="nav-link d-flex justify-content-between align-items-center" onClick={() => toggleDropdown("user")} style={{ cursor: "pointer" }}>
              <span>
                <span className="icon"><i className="fas fa-users"></i></span>
                <span className="text">User</span>
              </span>
              <span>{openDropdown === "user" ? <FaChevronUp /> : <FaChevronDown />}</span>
            </div>
            {openDropdown === "user" && (
              <ul className="nav flex-column ps-4">
                ...
                <li className="nav-item">
                  <Link to="/users/userbalance" className="nav-link" onClick={() => setSidebarVisible(false)}>
                    <FaBalanceScale  className="me-2" />
                    <span className="text">User Balance</span>
                  </Link>
                </li>
